...
def step_given_configuration_parent_single_child(context):
    ...
    context.configuration = {
        ...
        "child": {
            ...
            "params": json.loads(row["child_params"]),
        },
    }
...
@then(
    "the created object should be an instance of the Parent class with a single Child attribute"
)
...
@then(
    "the created object should be an instance of the Parent class with multiple Children attributes"
)
